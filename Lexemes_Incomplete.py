...
class Lexeme_Multi_Char(Lexeme):
    ...
    def feed(self, char: str) -> int:
        ...
        if self._chars:
            self._captured.append(self._chars)
...
class Lxm_Op_Power(Lexeme_Multi_Char):
    ...
    def feed(self,Lexeme_Multi_Char):
        print(Lexeme_Multi_Char, self._captured, self._state)
        if self._mode == 0:
            if Lexeme_Multi_Char == "*":
                self._captured.append(Lexeme_Multi_Char)
            else:
                self.set_fail()
